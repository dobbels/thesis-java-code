...
public class AliceEncryption {
    ...
    public AliceEncryption(AliceContext context) {
        if (context == null ||
    ...
    private byte[] generateInitializationVector() {
    	// Updated because a secret initial vector has been exchanged with the entities.
    	// For simplicity, this is the same one for all of them
    	if (context.getIvLength() != 16) {
    		System.out.println("Error! IV length is " + context.getIvLength());
    	}
    	return TrustedServer.Initial_Vector;
